...
const news = [
  {
    date: 'Sep 2026',
    html:
      '🏆 <strong>ULTRA</strong> named a <strong>Finalist</strong> for the IROS 2026 Best Paper Award on Mobile Manipulation.'
  },
  {
    date: 'Sep 2026',
    html:
    ...
    <Layout title="Home">
      <Container maxW="container.md">
        ...
        <Section delay={0.2}>
          ...
          <Paragraph>
            I&apos;m a 3rd year Ph.D. student in Computer Science at{' '}
